        ...
        try {
            ...
            while ((line = fileReader.readLine()) != null) {
                ...
                if (firstLine == false && tokens.length > 1) {
                    curTimestamp = DateUtils.parseDate(tokens[0], new String[]{"yyyy-MM-dd HH:mm:ss"}).getTime();
//                    curTimestamp = DateUtils.parseDate(tokens[0], new String[]{"yyyy/MM/dd HH:mm"}).getTime();
